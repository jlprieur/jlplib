...
jlp_gseg_data1->Get_ncontour_plots(ncontours_plots0);
...
*  (called by gsegraf_main/CreateMenuBar())
*************************************************************************/
int JLP_Gsegraf::GSEG_GetAxisLimitsFromTickLabelsForLinear(double *axis_limits0,
                                                         const int nval0)
{
...
if(nval0 == 6) {
  status = jlp_gseg_axes1->GetAxisLimitsFromTickLabelsForLinear(&xmin_0, 
                                                   &xmax_0, &ymin_0, &ymax_0, 
                                                   &zmin_0, &zmax_0);
  if(status == 0) {
...
/*************************************************************************
* Interface with JLP_GsegAxes::SetPlotParamAxisLimitsAndLabels
* to emulate miscel settings from the input parameter file
*************************************************************************/
int JLP_Gsegraf::GSEG_SetPlotParamAxisLimitsAndLabels(double *axis_limits_0, 
                                    int *reversed_axis0,
                                    char *axis_scale0, char *axis_type0,
                                    char *xlabel0, char *ylabel0, 
                                    char *zlabel0, char *title0)
{
return jlp_gseg_axes1->SetPlotParamAxisLimitsAndLabels(axis_limits_0,
                                     reversed_axis0,
                                     axis_scale0, axis_type0, xlabel0, ylabel0,
                                     zlabel0, title0);
}
