...
*
*************************************************************************/
void JLP_GsegAxes::DrawTickLabels2d (void)
{
/* Declare variables */
...
char text_anchor0[64], axis_type0[64];
   ...
   if ( strcmp(p_plot_param->x_tick_marks, "on")  == 0 &&
      ...
      DrawTickLabels(axis_type0,
                     ...
                     0.0, 8.0, text_anchor0, reversed_axis0);
      }
   ...
   if ( strcmp(p_plot_param->y_tick_marks, "on")  == 0 &&
      ...
      {
      strcpy(axis_type0, "linear");
      strcpy(text_anchor0, "EAST");
      reversed_axis0 = p_plot_param->reversed_axis[1];
      width_ytick_labels = DrawTickLabels(axis_type0, dev_x1_box, dev_y2_box,
                                          dev_x1_box, dev_y1_box,
                                          p_ticklabels->nyvalues, 
                                          &p_ticklabels->yvalues[0],
                                          p_ticklabels->yoffset1, 
                                          p_ticklabels->yoffset2,
                                          -8.0, 0.0, text_anchor0,
                                          reversed_axis0);
      }
