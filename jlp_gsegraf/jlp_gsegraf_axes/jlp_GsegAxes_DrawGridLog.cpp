...
void JLP_GsegAxes::DrawGridLog (void)
{
/* Declare variables */
...
/* Check plot_box parameter */
   ...
   if ( strcmp(p_plot_param->grid, "on1") == 0 ||
      ...
      if ( strcmp(p_plot_param->x_tick_marks, "on") == 0 &&
         ...
         DrawGrid("log", dev_x1_box, dev_y2_box, dev_x2_box, dev_y2_box, 
                  dev_x1_box, dev_y1_box,
      ...
      if ( strcmp(p_plot_param->y_tick_marks, "on") == 0 &&
         ...
         DrawGrid("log", dev_x1_box, dev_y2_box, dev_x1_box, dev_y1_box, 
                  dev_x2_box, dev_y2_box,
   ...
   if ( strcmp(p_plot_param->x_tick_marks, "on") == 0 &&
      ...
      DrawTickMarks("log", minor_ticks_flag, 0,
                    ...
                    p_ticklabels->nxvalues, &p_ticklabels->xvalues[0],
                    p_ticklabels->xoffset1, p_ticklabels->xoffset2,
                    90.0*DEGTORAD, reversed_axis0);   /* lower x-axis */

      DrawTickMarks("log", minor_ticks_flag, 0,
                    dev_x1_box, dev_y1_box, dev_x2_box, dev_y1_box,
                    p_ticklabels->nxvalues, &p_ticklabels->xvalues[0],
                    p_ticklabels->xoffset1, p_ticklabels->xoffset2,
                    -90.0*DEGTORAD, reversed_axis0);   /* upper x-axis */
      }
   ...
   if ( strcmp(p_plot_param->y_tick_marks, "on") == 0 &&
      ...
      DrawTickMarks("log", minor_ticks_flag, 0,
                    ...
                    p_ticklabels->nyvalues, &p_ticklabels->yvalues[0],
                    p_ticklabels->yoffset1, p_ticklabels->yoffset2,
                    0.0*DEGTORAD, reversed_axis0);   /* left y-axis */

      DrawTickMarks("log", minor_ticks_flag, 0,
                    dev_x2_box, dev_y2_box, dev_x2_box, dev_y1_box,
                    p_ticklabels->nyvalues, &p_ticklabels->yvalues[0],
                    p_ticklabels->yoffset1, p_ticklabels->yoffset2,
                    180.0*DEGTORAD, reversed_axis0);   /* right y-axis */
      }
