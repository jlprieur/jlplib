...
isize = nx * ny;
in_array = fftw_malloc(isize * sizeof(fftw_complex));
out_array = fftw_malloc(isize * sizeof(fftw_complex));
...
in_array = fftw_malloc(ny * sizeof(fftw_complex));
out_array = fftw_malloc(ny * sizeof(fftw_complex));
...
in_array_0 = fftw_malloc(nx0 * ny0 * sizeof(fftw_complex));
out_array_0 = fftw_malloc(nx0 * ny0 * sizeof(fftw_complex));
nx_0 = nx0;
ny_0 = ny0;
