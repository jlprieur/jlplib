...
*
********************************************************************/
int JLP_wxGseg_Canvas::NewNameForMetaFile()
{
int irand;
...
*
********************************************************************/
int JLP_wxGseg_Canvas::OpenMetaFile(const char* mode)
{
   if(MetaFileIsOpened == true) CloseMetaFile(); 
...
*
**********************************************************************/
int JLP_wxGseg_Canvas::CloseMetaFile()
{
...
*
**********************************************************************/
int JLP_wxGseg_Canvas::ReadAndExecuteMetaFile()
{
char metaline[80];
if(MetaFileIsOpened != true) return(-1);
...
*
**********************************************************************/
int JLP_wxGseg_Canvas::ExecuteMetaFileLine(char *metaline)
{
...
// JLP_wxGseg_Canvas::line_device(int x1, int y1, int x2, int y2, int lwidth)
...
// JLP_wxGseg_Canvas::label_device(const char *s, int xstart, int ystart,
//                            float angle1, float expand1, int drawit=1)
