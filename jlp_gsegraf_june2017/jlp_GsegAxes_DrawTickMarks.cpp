...
void JLP_GsegAxes::DrawTickMarks(char *axis_type, int minor_ticks_flag, int center_flag,
...
double axis_min, axis_max, xscale, yscale, major_increment, minor_increment,
       x1_tick, y1_tick;
