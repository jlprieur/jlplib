                 ...
                 unsigned int size0)
{
 switch(isymb1) {
   ...
   case 0:
   case 1:
     jlp_gseg1->GSEG_DrawCircle(x0, y0, size0, fill_color_rgba0,
                                outline_color_rgba0, 1);
     break;
   case 2:
   case 3:
     GSEG_DrawTriangle(x0, y0, fill_color_rgba0, outline_color_rgba0, size0);
     break;
   case 4:
   case 5:
     jlp_gseg1->GSEG_DrawSquare(x0, y0, size0, fill_color_rgba0, outline_color_rgba0, 1);
     break;
   case 6:
   case 7:
     DrawDiamond(x0, y0, fill_color_rgba0, outline_color_rgba0, size0);
     break;
   case 8:
   case 9:
     DrawPentagon(x0, y0, fill_color_rgba0, outline_color_rgba0, size0);
     break;
   case 10:
   case 11:
     DrawHexagon(x0, y0, fill_color_rgba0, outline_color_rgba0, size0);
     break;
 }
return;
}
                 ...
                 UINT32 fill_color_rgba0, unsigned int size0)
{
 switch(isymb2) {
   default:
   case 0:
     DrawPlus(x0, y0, fill_color_rgba0, size0);
   case 1:
     DrawX(x0, y0, fill_color_rgba0, size0);
   case 2:
     DrawStar(x0, y0, fill_color_rgba0, size0);
   case 3:
     DrawAsterisk(x0, y0, fill_color_rgba0, size0);
 }
return;
}
/************************************************************************
...
*
**************************************************************************/
void JLP_Gsegraf::DrawPlus(double x, double y, UINT32 fill_color_rgba, unsigned int size)
   {
   /* Declare variables */
   double r;
   JLP_CanvasPoints *points;
   ...
   if ( size == 0 )
      ...
      jlp_gseg1->GSEG_DrawLine(points, fill_color_rgba, line_width_one);
...
*
************************************************************************/
void JLP_Gsegraf::DrawX ( double x, double y, UINT32 fill_color_rgba, unsigned int size )
   {
   /* Declare variables */
   double dx, dy;
   JLP_CanvasPoints *points;
...
*
************************************************************************/
void JLP_Gsegraf::DrawStar(double x, double y, UINT32 fill_color_rgba, unsigned int size)
   {
   /* Declare variables */
   double r, dx1, dx2, dy1, dy2;
   JLP_CanvasPoints *points;
...
*
************************************************************************/
void JLP_Gsegraf::DrawAsterisk(double x, double y, UINT32 fill_color_rgba, 
                  unsigned int size)
   {
   /* Declare variables */
   double r, dx, dy;
