...
// jlp_GsegAxes_ReadPlotParameterFile.cpp
 int ReadAxisType(char *p_param_filename);
 int ReadBackgroundStyle(char *p_param_filename);
 int ReadAxisLimits(char *p_param_filename);
 int ReadFonts(char *p_param_filename);
...
// jlp_GsegAxes_GetPlotSettings.cpp
 ...
 int AxisLimitsFromTickLabelsForLinear(double *xmin_0, double *xmax_0,
                                       double *ymin_0, double *ymax_0,
                                       double *zmin_0, double *zmax_0);
...
/* Declare axis_type flags */
 ...
 UINT32 gridcolor1;
 char gridchar1, gridchar2, *xlabel1, *ylabel1, *zlabel1, *title1;
// string_get is used for reading lines (see gseg_get_string())
 char *background_image_file, *string_get;
