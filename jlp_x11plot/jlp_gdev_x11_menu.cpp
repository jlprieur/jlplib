/*************************************************************************
* "jlp_gdev_x11_menu.cpp
* JLP_GDev_X11 Class: menu routines
*
...
*
**********************************************************************/
int JLP_GDev_X11::setup_menu(char *items, int nitems, int menu_nsub, int menu_slen,
                        int vertical)
{
...
***************************************************************************/
int JLP_GDev_X11::CreateMenuButtons(char *items, const int nitems, 
...
// Maximum width of button is 1/10th of window width:
 ...
 ix = ix0; iy = iy0;
 d_width = (int)(width0 * g_dx);
 d_height = (int)(height0 * g_dy);
 Xgc0.nbuttons = 0;
...
*
***************************************************************************/
int JLP_GDev_X11::create_menu_gc()
{
int line_width;
...
*                      (device coordinates) 
***************************************************************************/
int JLP_GDev_X11::CreatePopupMenu(XBUTTON& MyBut, const char *items, 
...
// jj is a parameter to tune this offset:
    ...
    d_y = MyBut.y;
    d_x = MINI(Jgc0.dev_width - d_width - jj, d_x);
    d_x = MAXI(d_x, jj);
    d_y = MINI(Jgc0.dev_height - d_height * nitems - jj, d_y);
    d_y = MAXI(d_y, jj);
} else {
    jj = 4;
    d_x = MyBut.x;
...
***************************************************************************/
int JLP_GDev_X11::CreateButton(XBUTTON &MyBut, const char *label, const int x_ul, 
...
*
***************************************************************************/
int JLP_GDev_X11::DrawButton(XBUTTON& MyBut)
{
int slen, x, y;
unsigned long int mygray;
...
*
***************************************************************************/
int JLP_GDev_X11::DrawPopupMenu(XBUTTON& MyBut)
{
...
*
***************************************************************/
int JLP_GDev_X11::select_menu(int& select, int& subselect)
{
register int i, j;
int x1, y1;
XEvent event;
...
* (called by JLP_GDev_X11::cursor(), JLP_GDev_X11::winlimits(), JLP_GDev_X11::get_circles())
*
* OUTPUT:
...
*           0  otherwise
**********************************************************************/
int JLP_GDev_X11::button_was_pressed(XEvent& event, int& select)
{
register int i;
