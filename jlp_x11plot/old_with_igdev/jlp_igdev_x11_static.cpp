/*************************************************************************
* "jlp_igd_x11_static.cpp
* JLP_iGDev_X11 Class:  routines to define Static buttons and Check buttons
*
...
***************************************************************************/
int JLP_iGDev_X11::CreateStaticButton(XSTATIC &MyStat, const char *label, 
...
*/
  d_width = (int)((double)width * Jgc0.g_dx);
  d_height = (int)((double)height * Jgc0.g_dy);
...
***************************************************************************/
int JLP_iGDev_X11::EraseStatusBar()
{
int status = -1;
...
***************************************************************************/
int JLP_iGDev_X11::EraseCursorPosition()
{
int status = -1;
...
***************************************************************************/
int JLP_iGDev_X11::DrawToStatusBar(char *label)
{
int status = -1;
...
***************************************************************************/
int JLP_iGDev_X11::DrawToCursorPosition(char *label)
{
int status = -1;
...
***************************************************************************/
int JLP_iGDev_X11::DrawStaticButton(XSTATIC &MyStat)
{
