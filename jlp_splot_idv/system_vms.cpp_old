...
int system(char *string)
{
   ...
   if((ret = dcl(string)) == -1) {
      printf("Error in DCL call\n");
   } else if(ret%2 == 0) {		/* error return */
     printf("DCL returns %d\n",ret);
   }
   return(ret);
}
/*
...
int system(char *str)
{
   printf("I don't know how to pass a string to the O/S. String =\n%s",str);
   return(-1);
}
#endif
#endif /* endif vms */
#endif /* endif HAVE_SYSTEM */
